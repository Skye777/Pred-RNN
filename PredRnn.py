...
class Encoder(nn.Module):
    ...
    def __init__(self, n_layers, hidden_sizes, input_sizes, batch_size, height, width, use_cuda):
        ...
        for i in range(self.n_layers):
            cell = SpatioTemporal_LSTM(self.hidden_sizes[i], self.input_sizes, batch_size, height, width)
...
class Decoder(nn.Module):
    ...
    def __init__(self, n_layers, hidden_sizes, input_sizes, batch_size, height, width, use_cuda):
        ...
        for i in self.n_layers:
            cell = SpatioTemporal_LSTM(self.hidden_sizes[i], self.input_sizes[i], batch_size, height, width)
            self.cells.append(cell)
